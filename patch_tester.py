...
from parser import get_argparser, load_config_object
from patch import PatchApplier, PatchTransformer

from adv_patch_utils.common import IMG_EXTNS, BColors, pad_to_square
...
class PatchTester:
    ...
    def __init__(self, cfg: edict) -> None:
        ...
        model = ultralytics.YOLO(cfg.weights_file).to(self.device)
